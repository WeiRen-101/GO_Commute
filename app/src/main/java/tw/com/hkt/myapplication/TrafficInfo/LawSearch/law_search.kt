...
import tw.com.hkt.myapplication.TrafficInfo.LawSearch.MyAdapter
...
class law_search : AppCompatActivity() {
    ...
    // 初始化過濾後的資料
    private var filteredList = mutableListOf<Pair<String, String>>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filteredList.addAll(itemList) // 一開始顯示所有項目
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                if (!newText.isNullOrEmpty()) {
                    ...
                    val results = itemList.filter {
                        it.first.lowercase().contains(searchText) || it.second.lowercase().contains(searchText)
                    }
                    filteredList.addAll(results)
                    adapter.updateSearchText(searchText)
                } else {
